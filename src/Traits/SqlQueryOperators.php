...
trait SqlQueryOperators
{
    ...
    protected $sqlOperators = [
        ...
        'begins_with_case' => ['method' => 'where', 'op' => 'like', 'mod' => '?%'],
        'not_begins_with_case' => ['method' => 'where', 'op' => 'not like', 'mod' => '?%'],
        'contains_case' => ['method' => 'where', 'op' => 'like', 'mod' => '%?%'],
        'not_contains_case' => ['method' => 'where', 'op' => 'not like', 'mod' => '%?%'],
        'ends_with_case' => ['method' => 'where', 'op' => 'like', 'mod' => '%?'],
        'not_ends_with_case' => ['method' => 'where', 'op' => 'not like', 'mod' => '%?'],
